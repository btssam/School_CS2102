...
/**
 * An abstract class that implements {@link ClubManagable} to provide a club management system using the Template Method
 * Pattern.
 *
...
public abstract class ClubRostersTemplate implements ClubManagable {
    ...
    /**
     * This helper constructor is called by its inherited classes to create a new club management system.
     */
    ...
    /**
     * A helper method for processing the clean-parse-sort phases to the data.
     */
