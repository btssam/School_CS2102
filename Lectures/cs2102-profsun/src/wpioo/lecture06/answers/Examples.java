...
public class Examples {
    ...
    /**
     * This test case checks to see if two heating systems are equal.
     */
    @Test
    public void testHeatingSystemEquals() {
        // propane: 11900 C L / kg
        // Pick nice numbers to make the math easy for a simple test
        Furnace furnace = new Furnace(10.0);
        WaterTank waterTank = new WaterTank(119000, 50, 50.0);
        ...
        // propane: 11900 C L / kg
        // Pick nice numbers to make the math easy for a simple test
        Furnace furnace1 = new Furnace(10.0);
        WaterTank waterTank1 = new WaterTank(119000, 50.0, 50.0);
        FuelTank fuelTank1 = new FuelTank(10000, 11900);
        HeatingSystem heatingSystem1 = new HeatingSystem(furnace1, waterTank1, fuelTank1);

        assertEquals(heatingSystem, heatingSystem1);
    }

    /**
     * This test case checks to see if two heating systems are not equal.
     */
    @Test
    public void testHeatingSystemNotEquals() {
        // propane: 11900 C L / kg
        // Pick nice numbers to make the math easy for a simple test
        Furnace furnace = new Furnace(10.0);
        WaterTank waterTank = new WaterTank(119000, 50, 50.0);
        ...
        // Pick nice numbers to make the math easy for a simple test
        Furnace furnace1 = new Furnace(10.0);
        WaterTank waterTank1 = new WaterTank(119000, 50, 40.0);
        FuelTank fuelTank1 = new FuelTank(10000, 11900);
        HeatingSystem heatingSystem1 = new HeatingSystem(furnace1, waterTank1, fuelTank1);

        assertNotEquals(heatingSystem, heatingSystem1);
    }
}
