...
/**
 * A class acting as a mutable, encapsulated binary tree parameterized by the strategy used to add and remove data and
 * an object to validate any invariants
 * <p>
...
public class BinaryTree<E> {
     ...
     */
    protected IBinTree<E> data = new BTEmpty<>();
     ...
     *
     * @param strategy
     *            the strategy used to add and remove integers to this tree
     * @param validator
     *            the validator which reports success after add and remove is called
     */
     ...
     *
     * @param bt
     *            the binary tree which we copy the data, strategy, and validator from
     */
     ...
     *
     * @param elements
     *            the initial numbers to add to the tree with the default strategy.
     */
     ...
     *
     * @param bt
     *            the particular immutable tree to start with
     */
    ...
    /**
     * "add element" Uses the current strategy to make a tree by adding a number to the current tree
     *
     * @param elt
     *            the element to add
     *
     ...
     *
     * @return Number of non-leave nodes
     */
    public int size() {
     ...
     *
     * @param nextStrategy
     *            a strategy for adding and removing numbers from an IBinTree
     */
     ...
     *
     * @param nextValidator
     *            a validator for checking if a particular operation respected the invariants of this tree
     */
