package wpioo.lecture18.answers;
...
public class ExampleSetApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------");
        Set<String> intersection = new HashSet<>(uniqueTale);
        intersection.retainAll(uniqueAesop);
        ...
        System.out.println("----------------------------------------");
        Set<String> difference1 = new HashSet<>(uniqueTale);
        difference1.removeAll(uniqueAesop);
        ...
        Set<String> difference2 = new HashSet<>(uniqueAesop);
        difference2.removeAll(uniqueTale);
